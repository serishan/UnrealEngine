...
// Cross Module References
	...
	CAMERACONVERTER_API UFunction* Z_Construct_UFunction_UCameraConverterTool_ChangeSelectedActorsVisibility();
...
// End Cross Module References
	void UCameraConverterTool::StaticRegisterNativesUCameraConverterTool()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			{ "ChangeSelectedActorsVisibility", &UCameraConverterTool::execChangeSelectedActorsVisibility },
			{ "ConvertCamera", &UCameraConverterTool::execConvertCamera },
		};
		FNativeFunctionRegistrar::RegisterFunctions(Class, Funcs, ARRAY_COUNT(Funcs));
	}
	struct Z_Construct_UFunction_UCameraConverterTool_ChangeSelectedActorsVisibility_Statics
	{
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UCameraConverterTool_ChangeSelectedActorsVisibility_Statics::Function_MetaDataParams[] = {
		{ "CallInEditor", "true" },
		{ "Category", "Action" },
		{ "ModuleRelativePath", "Public/CameraConverterTool.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UCameraConverterTool_ChangeSelectedActorsVisibility_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UCameraConverterTool, nullptr, "ChangeSelectedActorsVisibility", nullptr, nullptr, 0, nullptr, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UCameraConverterTool_ChangeSelectedActorsVisibility_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UCameraConverterTool_ChangeSelectedActorsVisibility_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UCameraConverterTool_ChangeSelectedActorsVisibility()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UCameraConverterTool_ChangeSelectedActorsVisibility_Statics::FuncParams);
		}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UCameraConverterTool_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UCameraConverterTool_ChangeSelectedActorsVisibility, "ChangeSelectedActorsVisibility" }, // 1204108857
		{ &Z_Construct_UFunction_UCameraConverterTool_ConvertCamera, "ConvertCamera" }, // 2837360328
	};
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UCameraConverterTool_Statics::ClassParams = {
		...
		ARRAY_COUNT(Z_Construct_UClass_UCameraConverterTool_Statics::PropPointers),
		0,
		0x000000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UCameraConverterTool_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UCameraConverterTool_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UCameraConverterTool, 4234948170);
